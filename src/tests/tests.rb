...
require File.expand_path(File.join(File.dirname(__FILE__), "dcel_tests"))
...
module Test
  ...
  def self.run
    ...
    assert("dcel.h: incident_he_to_v aristas adyacentes dado un vertice",TestDCEL.incident_he_to_v)
    assert("dcel.h: incident_f_to_f, caras adyacentes dado una cara", TestDCEL.incident_f_to_f)
    assert("dcel.h: incident_he_to_f, aristas adyacentes dad una cara", TestDCEL.incident_he_to_f)
    puts ""
